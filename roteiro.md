...
O site funciona como demonstração. A tela principal contém a escolha do orçamento, do objetivo e dos jogos; as informações técnicas ficam nas áreas recolhíveis. Use tela cheia (F11) e, se necessário, zoom do navegador. Aumentar o zoom não altera o algoritmo.

## 1. Problema e objetivo — 1 minuto

“Queremos selecionar o melhor conjunto de jogos da Steam respeitando orçamento e/ou espaço em disco, maximizando avaliações positivas, satisfação ou horas médias jogadas. É uma variação do Problema da Mochila.”
...
1. Informe orçamento 100 e escolha **Quantidade de avaliações positivas**.
...
3. Clique em **Encontrar jogos** e mostre as capas, o custo e a contagem de avaliações.
4. Mude o orçamento para 50, repita e compare a seleção.
5. Volte a 100 e troque o objetivo para satisfação. Explique por que aparecem jogos diferentes: a função de valor mudou.
...
Compare o resultado com a referência por valor/recurso e a melhor combinação inicial. Não afirme superioridade do AG: na validação padrão, a gulosa foi melhor em satisfação e avaliações positivas; o AG ficou acima em horas médias. Explique que a comparação mostra uma limitação real e que parâmetros diferentes podem gerar resultados diferentes.
...
“Sem limite de disco, jogos gratuitos com valor positivo sempre ajudam no nosso objetivo. A satisfação somada favorece jogos baratos com aprovação alta e pode dar peso excessivo a poucos votos. Horas médias somadas também não significam uma previsão individual de diversão.”
